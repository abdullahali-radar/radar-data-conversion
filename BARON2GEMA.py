...
baronFolder='D:/project_webprogramming/wxradarexplore/radarDataConversion/YOG_odim'
gemaFolder='D:/Rainbow5.40/rainbow/rawdata'
rb5bin='D:/Rainbow5.40/rainbow/bin'
sesnsorID='Yogyakarta'
siteID='YOG'
scanning='VCP21_SOP.vol'
for file in os.listdir(baronFolder):
    print(file)
    time=datetime(int(file[5:9]),int(file[9:11]),int(file[11:13]),int(file[14:16]),int(file[16:18]))
    infile='{}/{}'.format(baronFolder,file)
